...
- Backup replication flows as follows: From Primary Falconstor VTL appliance in Site 1 to the Power Edge Router (PER), then through the Global Transit Gateway (TGW) in Site 2 to Site 2 PER and finally reaches the second Falconstor VTL appliance.
