...
- The Falconstor sizing calculator can be found by going to [IBM Power Sizing Calculator](https://www.falconstor.com/sizing-calculator/?source=ibm){: external}.
